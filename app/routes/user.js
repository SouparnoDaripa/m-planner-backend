...
let setRouter = (app) => {
    ...
    /**
     * @api {post} /api/v1/users/getAll API for user login
    ...
    /**
     * @api {post} /api/v1/users/forgotPassword API for user login
     * @apiName API for user login
     * @apiGroup users
     * @apiVersion 1.0.0
     * 
    ...
    /**
     * @api {post} /api/v1/users/resetpassword API for user login
     * @apiName API for user login
     * @apiGroup users
     * @apiVersion 1.0.0
     * 
